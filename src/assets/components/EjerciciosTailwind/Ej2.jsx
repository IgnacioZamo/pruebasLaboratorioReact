...
const Ej2 = () => {
  return (
    <div className='w-4/5 h-96 mx-auto mt-3 border relative flex'>
      <div className='h-full w-1/4 border relative'>
      ...
      <div className='h-full w-3/4 border p-4 relative'>
        ...
        <img className=' z-0 h-5/6 absolute right-32 bottom-6' src="https://img.freepik.com/fotos-premium/pagina-colorear-retratos-adultos-pagina-imprimible_349618-12088.jpg?size=626&ext=jpg&ga=GA1.1.1803636316.1701216000&semt=ais" alt="" />
